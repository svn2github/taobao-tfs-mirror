 ...
 *
 */
#ifndef  TFS_COMMON_CRC_H_
#define  TFS_COMMON_CRC_H_
...
// ob_crc64 is just an adaptor for old interface
// all the result in ob_crc64 are in the range of uint32_t
// ob_crc32 is added for tfs
