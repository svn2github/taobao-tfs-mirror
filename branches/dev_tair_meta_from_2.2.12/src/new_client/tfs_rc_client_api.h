  ...
  namespace client
  {
    ...
    class RcClient
    {
      ...
      public:
        ...
        TfsRetType del_multi_objects(const char *bucket_name, const std::set<std::string> &s_object_name,
        ...
        int64_t pwrite_upload_multipart(const char *bucket_name, const char *object_name,
