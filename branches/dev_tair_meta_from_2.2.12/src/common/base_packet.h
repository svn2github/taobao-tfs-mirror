...
namespace tfs
{
  ...
  #pragma pack()
    ...
    enum MessageType
    {
      ...
      KV_REQ_GET_META_MESSAGE = 300,
      KV_REQ_PUT_META_MESSAGE = 301,
      KV_RSP_GET_META_MESSAGE = 302,
      KV_REQ_PUT_BUCKET_MESSAGE = 303,
      KV_REQ_GET_BUCKET_MESSAGE = 304,
      KV_RSP_GET_BUCKET_MESSAGE = 305,
      KV_REQ_DELETE_BUCKET_MESSAGE = 306,
      LOCAL_PACKET = 500
    };
