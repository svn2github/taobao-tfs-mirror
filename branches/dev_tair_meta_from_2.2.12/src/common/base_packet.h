...
namespace tfs
{
  ...
  #pragma pack()
    ...
    enum MessageType
    {
      ...
      REQ_KVMETA_HEAD_OBJECT_MESSAGE = 304,
      RSP_KVMETA_HEAD_OBJECT_MESSAGE = 305,

      REQ_KVMETA_PUT_BUCKET_MESSAGE = 306,
      REQ_KVMETA_GET_BUCKET_MESSAGE = 307,
      RSP_KVMETA_GET_BUCKET_MESSAGE = 308,
      REQ_KVMETA_DEL_BUCKET_MESSAGE = 309,
      REQ_KVMETA_HEAD_BUCKET_MESSAGE = 310,
      RSP_KVMETA_HEAD_BUCKET_MESSAGE = 311,
