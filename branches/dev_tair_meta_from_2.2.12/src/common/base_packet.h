...
namespace tfs
{
  ...
  #pragma pack()
    ...
    enum MessageType
    {
      ...
      REQ_KVMETA_GET_SERVICE_MESSAGE = 202,
      RSP_KVMETA_GET_SERVICE_MESSAGE = 203,
      ...
      REQ_KVMETA_PUT_BUCKET_TAG_MESSAGE = 313,
      REQ_KVMETA_GET_BUCKET_TAG_MESSAGE = 314,
      RSP_KVMETA_GET_BUCKET_TAG_MESSAGE = 315,
      REQ_KVMETA_DEL_BUCKET_TAG_MESSAGE = 316,

      REQ_KVMETA_LIST_MULTIPART_OBJECT_MESSAGE = 317,
      RSP_KVMETA_LIST_MULTIPART_OBJECT_MESSAGE = 318,

      REQ_KVMETA_PUT_BUCKET_ACL_MESSAGE = 319,
      REQ_KVMETA_GET_BUCKET_ACL_MESSAGE = 320,
      RSP_KVMETA_GET_BUCKET_ACL_MESSAGE = 321,

      REQ_KVMETA_DEL_MULTI_OBJECT_MESSAGE = 322,
      RSP_KVMETA_DEL_MULTI_OBJECT_MESSAGE = 323,

      REQ_KVMETA_PUT_BUCKET_LOGGING_MESSAGE = 324,
      REQ_KVMETA_GET_BUCKET_LOGGING_MESSAGE = 325,
      RSP_KVMETA_GET_BUCKET_LOGGING_MESSAGE = 326,
      ...
      REQ_KVMETA_INIT_MULTIPART_MESSAGE = 360,
      RSP_KVMETA_INIT_MULTIPART_MESSAGE = 361,
      REQ_KVMETA_UPLOAD_MULTIPART_MESSAGE = 362,
      RSP_KVMETA_UPLOAD_MULTIPART_MESSAGE = 363,
      REQ_KVMETA_COMPLETE_MULTIPART_MESSAGE = 364,
      RSP_KVMETA_COMPLETE_MULTIPART_MESSAGE = 365,
      REQ_KVMETA_LIST_MULTIPART_MESSAGE = 366,
      RSP_KVMETA_LIST_MULTIPART_MESSAGE = 367,
      REQ_KVMETA_ABORT_MULTIPART_MESSAGE = 368,
      RSP_KVMETA_ABORT_MULTIPART_MESSAGE = 369,

      REQ_KV_APPLY_AUTHORIZE_MESSAGE = 370,
      RSP_KV_APPLY_AUTHORIZE_MESSAGE = 371,
      REQ_KV_GET_AUTHORIZE_MESSAGE = 372,
      RSP_KV_GET_AUTHORIZE_MESSAGE = 373,
      LOCAL_PACKET = 500
    };
