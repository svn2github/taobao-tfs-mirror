...
TEST_F(TfsInit,01_updata_char_right_T_DEFAULT)
{
	 ...
	 suffix=NULL;
	 flag=T_DEFAULT;
	 ret=tfsclient->save_update(tfs_name,buf,count,flag,suffix);
	 EXPECT_EQ(100*(1<<10),ret);
...
TEST_F(TfsInit,10_save_T_UNLINK_updata_char_right_T_DEFAULT)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,11_updata_char_T_LARGE_with_small)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,12_updata_char_T_DEFAULT_with_large)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,13_updata_char_large)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,14_updata_char_T_DEFAULT_with_count)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
	 ...
	 ret=tfsclient->stat_file(file_stat,tfs_name,suffix);
	 EXPECT_EQ(TFS_SUCCESS,ret);
	 EXPECT_EQ(110*(1<<10),file_stat->size_);
	 
	 Ret=tfsclient->unlink(con, tfs_name, NULL,NULL);
	 ASSERT_NE(TFS_ERROR,Ret);
}

TEST_F(TfsInit,15_updata_char_T_DEFAULT_more_count)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,16_updata_char_T_DEFAULT_wrong_count)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,17_updata_char_T_DEFAULT_empty_tfsname)
{
     char*tfs_name="";
	 char  buf[100*(1<<10)];
	 int64_t count;
...
TEST_F(TfsInit,18_updata_char_T_DEFAULT_null_tfsname)
{
     char*tfs_name=NULL;
	 char  buf[100*(1<<10)];
	 int64_t count;
...
TEST_F(TfsInit,19_updata_char_T_DEFAULT_wrong_tfsname)
{
...
TEST_F(TfsInit,20_updata_char_T_DEFAULT_empty_buf)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char* buf="";
...
TEST_F(TfsInit,21_updata_char_T_DEFAULT_null_buf)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char* buf=NULL;
...
TEST_F(TfsInit,22_updata_char_T_DEFAULT_dif_suffix)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,23_updata_char_T_DEFAULT_same_suffix)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,24_updata_char_T_DEFAULT_dif_suffix_2)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,25_updata_char_T_DEFAULT_with_nsaddr)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
	 ...
	 suffix=NULL;
	 flag=T_DEFAULT;
	 ret=tfsclient->save_update(tfs_name,buf,count,flag,suffix,ns_addr);
	 EXPECT_EQ(100*(1<<10),ret);
	 ret=tfsclient->stat_file(file_stat,tfs_name,suffix);
	 EXPECT_EQ(TFS_SUCCESS,ret);
	 EXPECT_EQ(200*(1<<10),file_stat->size_);
...
TEST_F(TfsInit,26_updata_char_T_DEFAULT_dif_nsaddr)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
	 ...
	 suffix=NULL;
	 flag=T_DEFAULT;
	 ret=tfsclient->save_update(tfs_name,buf,count,flag,suffix,ns_addr2);
	 EXPECT_EQ(100*(1<<10),ret);
	 ret=tfsclient->stat_file(file_stat,tfs_name,suffix);
	 EXPECT_EQ(TFS_SUCCESS,ret);
	 EXPECT_EQ(200*(1<<10),file_stat->size_);
...
TEST_F(TfsInit,27_updata_char_T_DEFAULT_not_exist_nsaddr)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,27_updata_char_T_DEFAULT_wrong_nsaddr)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,28_updata_char_T_DEFAULT_with_key)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
	 ...
	 suffix=NULL;
	 flag=T_DEFAULT;
	 ret=tfsclient->save_update(tfs_name,buf,count,flag,suffix,NULL,key);
	 EXPECT_EQ(100*(1<<10),ret);
	 ret=tfsclient->stat_file(file_stat,tfs_name,suffix);
	 EXPECT_EQ(TFS_SUCCESS,ret);
	 EXPECT_EQ(200*(1<<10),file_stat->size_);
...
TEST_F(TfsInit,29_updata_char_T_DEFAULT_empty_key)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,30_updata_char_T_DEFAULT_wrong_key)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
...
TEST_F(TfsInit,31_updata_many_times)
{
     char tfs_name[19];
	 int32_t tfs_name_len=19;
	 char  buf[100*(1<<10)];
