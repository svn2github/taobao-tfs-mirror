...
public class RestfulTfsCreateDirWithParents extends RestfulTfsBaseCase
{
    @Test
    public void test_01_createDirWithParents_right_filePath()
    {
        ...
        Assert.assertEquals(TfsConstant.TFS_SUCCESS, iRet);
    ...
    public void test_02_createDirWithParents_wrong_filePath_01()
    {
        ...
        Assert.assertEquals(iRet,TfsConstant.EXIT_INVALID_FILE_NAME);
    }
...
//        Assert.assertFalse("create dir with wrong filepath should be not zero", (0 == iRet) );
    ...
    public void test_08_createDirWithParents_parents_exsit()
    {
        ...
        Assert.assertEquals(TfsConstant.TFS_SUCCESS,Ret);
        ...
        Assert.assertTrue("Create Dir with parents exsit should be zero", (TfsConstant.TFS_SUCCESS == iRet) );
    ...
    public void test_09_createDirWithParents_some_parents_exsit()
    {
        ...
        Assert.assertEquals(TfsConstant.TFS_SUCCESS,0);
    
        iRet = tfsManager.createDirWithParents(appId, userId, "/testCDWP09/testCDWP109/testCDWP");
        Assert.assertTrue("Create Dir with some parents exsit should be zero", (TfsConstant.TFS_SUCCESS == iRet) );
    ...
    public void test_10_createDirWithParents_twice_filePath()
    {
        ...
        Assert.assertTrue("Create Dir should be zero", (TfsConstant.TFS_SUCCESS == iRet) );

        iRet = tfsManager.createDirWithParents(appId, userId, "/testCDWP10/testCDWP");
        Assert.assertEquals(iRet,TfsConstant.EXIT_TARGET_EXIST_ERROR);
