...
public class RestfulTfsMvDir extends RestfulTfsBaseCase 
{
	@Test
	public void test_01_mvDir_right()
	{
       ...
       Assert.assertEquals("mvDir with right path should be true", Ret,TfsConstant.TFS_SUCCESS);
       
       Ret = tfsManager.rmDir(appId, userId, "/textmvDir1rtar");
       Assert.assertEquals("mvDir with remove tarpath should be true", Ret,TfsConstant.TFS_SUCCESS);
	   Ret=tfsManager.rmDir(appId, userId, "/textmvDir1rsrc");
	   Assert.assertEquals("mvDir with remove srcpath should be false", Ret,TfsConstant.EXIT_TARGET_EXIST_ERROR);
	}
	@Test
	public void test_02_mvDir_srcFilePath_with_File()
	{
	   ...
	   Assert.assertEquals("mvDir with remove path should be false", Ret,TfsConstant.EXIT_TARGET_EXIST_ERROR);
	}
	@Test
	...
	public void test_04_mvDir_exit_destFilePath()
	{
	   ...
	   Ret=tfsManager.mvDir(appId, userId, "/textmvDir1", "/textmvDir2");
       Assert.assertEquals("mvDir with created path should be false", Ret,TfsConstant.EXIT_TARGET_EXIST_ERROR);
	...
	public void test_05_mvDir_empty_srcFilePath()
	{
	   ...
	   Assert.assertEquals("mvDir with empty srcFilePath should be false", Ret,TfsConstant.EXIT_INVALID_FILE_NAME);
	}
	@Test
	public void test_06_mvDir_null_srcFilePath()
	{
	   ...
	   Assert.assertEquals("mvDir with null srcFilePath should be false", Ret,TfsConstant.EXIT_INVALID_FILE_NAME);
	}
	@Test
	public void test_07_mvDir_wrong_srcFilePath_1()
	{
	   ...
	   Ret=tfsManager.mvDir(appId, userId, "textmvDir1", "/textmvDir2");
	   Assert.assertEquals("mvDir with wrong1 srcFilePath should be false", Ret,TfsConstant.EXIT_INVALID_FILE_NAME);
	   tfsManager.rmDir(appId, userId, "/textmvDir1");
	}
	@Test
	public void test_08_mvDir_wrong_srcFilePath_2()
	{
	   ...
	   log.info(new Throwable().getStackTrace()[0].getMethodName());
	   Ret=tfsManager.mvDir(appId, userId, "/", "/textmvDir2");
	   Assert.assertEquals("mvDir with wrong1 srcFilePath should be false", Ret,TfsConstant.EXIT_MOVE_TO_SUB_DIR_ERROR);
	}
	@Test
	public void test_09_mvDir_empty_destFilePath()
	{
	   ...
	   Assert.assertEquals("mvDir with empty destFilePath should be false", Ret,TfsConstant.EXIT_INVALID_FILE_NAME);
       tfsManager.rmDir(appId, userId, "/textmvDir1");
	}
	@Test
	public void test_10_mvDir_null_destFilePath()
	{
	   ...
	   Assert.assertEquals("mvDir with null destFilePath should be false", Ret,TfsConstant.EXIT_INVALID_FILE_NAME);
       tfsManager.rmDir(appId, userId, "/textmvDir1");
	}
	@Test
	public void test_11_mvDir_wrong_destFilePath_1()
	{
	   ...
	   Ret=tfsManager.createDir(appId, userId, "/textmvDir1");
	   Ret=tfsManager.mvDir(appId, userId, "/textmvDir1", "/");
	   Assert.assertEquals("mvDir with wrong destFilePath should be false", Ret,TfsConstant.EXIT_INVALID_FILE_NAME);
       tfsManager.rmDir(appId, userId, "/textmvDir1");
	}
	@Test
	public void test_12_mvDir_wrong_destFilePath_2()
	{
	   ...
	   Ret=tfsManager.createDir(appId, userId, "/textmvDir1");
	   Ret=tfsManager.mvDir(appId, userId, "/textmvDir1", "textmvDir2");
	   Assert.assertEquals("mvDir with wrong 2 destFilePath should be false", Ret,TfsConstant.EXIT_INVALID_FILE_NAME);
       tfsManager.rmDir(appId, userId, "/textmvDir1");
	}
	@Test
	public void test_13_mvDir_wrong_destFilePath_3()
	{
	   ...
	   Ret=tfsManager.createDir(appId, userId, "/textmvDir1");
	   Ret=tfsManager.mvDir(appId, userId, "/textmvDir1", "///textmvDir2///");
	   Assert.assertEquals("mvDir with wrong 3 destFilePath be true", Ret,TfsConstant.TFS_SUCCESS);
       tfsManager.rmDir(appId, userId, "/textmvDir2");
	}
	@Test
	public void test_14_mvDir_with_leap_destFilePath()
	{
	   ...
	   Assert.assertEquals("mvDir with leap path should be true", Ret,TfsConstant.TFS_SUCCESS);
       tfsManager.rmDir(appId, userId, "/textmvDir2/textmvDir");
       tfsManager.rmDir(appId, userId, "/textmvDir2");
	}
	@Test
	public void test_15_mvDir_with_same_File_destFilePath()
	{
	   ...
	   Ret=tfsManager.mvDir(appId, userId, "/textmvDir1", "/textmvDir2");
	   Assert.assertEquals("mvDir with the same path with File name should be false", Ret,TfsConstant.EXIT_TARGET_EXIST_ERROR);
       tfsManager.rmDir(appId, userId, "/textmvDir1");
	...
	public void test_16_mvDir_srcFilePath_same_destFilePath()
	{
	   ...
	   Assert.assertEquals("mvDir with the same path should be false", Ret,TfsConstant.EXIT_INVALID_ARGU_ERROR);
	   System.out.println("@@@@@@@@@@@@@@@@@+"+Ret);
       tfsManager.rmDir(appId, userId, "/textmvDir1");
	}
	@Test
	...
	public void test_18_mvDir_with_dif_uid()
   {
       ...
       Assert.assertEquals("mvDir with different uid should be false", Ret,TfsConstant.EXIT_INVALID_FILE_NAME);
   }
	@Test
	public void test_19_mvDir_circle()
	{
       ...
       Assert.assertEquals("mvDir with circle path should be false", Ret,TfsConstant.EXIT_MOVE_TO_SUB_DIR_ERROR);
