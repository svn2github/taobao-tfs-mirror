...
public class tfsManager_02_mvDir extends tfsNameBaseCase 
{
	...
	public void test_02_mvDir_srcFilePath_with_File()
	{
	   ...
	   bRet=tfsManager.createDir (userId, "/text1");
	   bRet=tfsManager.createFile (userId, "/text1/text");
	   bRet=tfsManager.mvDir (userId, "/text1", "/text2");
       Assert.assertTrue("mvDir with right path should be true", bRet);
       
        tfsManager.rmDir (userId, "/text2/text");
        tfsManager.rmFile (userId, "/text2/text");
        tfsManager.rmDir (userId, "/text2");
	    bRet=tfsManager.rmDir (userId, "/text1");
	    Assert.assertFalse("mvDir with remove path should be false", bRet);
	}
	...
	public void test_03_mvDir_srcFilePath_with_File_and_Dir()
	{
	   ...
	   bRet=tfsManager.createDir (userId, "/text1");
	   bRet=tfsManager.createFile (userId, "/text1/text");
	   bRet=tfsManager.createDir (userId, "/text1/text1");
	   bRet=tfsManager.mvDir (userId, "/text1", "/text2");
       Assert.assertTrue("mvDir with right path should be true", bRet);
       
       tfsManager.rmDir (userId, "/text2/text1");
       tfsManager.rmFile (userId, "/text2/text");
       tfsManager.rmDir (userId, "/text2");
	   bRet=tfsManager.rmDir (userId, "/text1");
	   Assert.assertFalse("mvDir with remove path should be false", bRet);
	...
	public void test_04_mvDir_exit_destFilePath()
	{
	   ...
	   bRet=tfsManager.createDir (userId, "/text1");
	   bRet=tfsManager.createDir (userId, "/text2");
	   bRet=tfsManager.mvDir (userId, "/text1", "/text2");
	...
	public void test_05_mvDir_empty_srcFilePath()
	{
	   ...
	   bRet=tfsManager.mvDir (userId, "", "/text2");
	...
	public void test_06_mvDir_null_srcFilePath()
	{
	   ...
	   bRet=tfsManager.mvDir (userId, null, "/text2");
	...
	public void test_09_mvDir_empty_destFilePath()
	{
	   ...
	   bRet=tfsManager.createDir (userId, "/text1");
	   bRet=tfsManager.mvDir (userId, "/text1", "");
	...
	public void test_10_mvDir_null_destFilePath()
	{
	   ...
	   bRet=tfsManager.createDir (userId, "/text1");
	   bRet=tfsManager.mvDir (userId, "/text1", null);
	...
	public void test_14_mvDir_with_leap_destFilePath()
	{
	   ...
	   bRet=tfsManager.createDir (userId, "/text1");
	   bRet=tfsManager.mvDir (userId, "/text1", "/text2/text");
	...
	public void test_16_mvDir_srcFilePath_same_destFilePath()
	{
	   ...
	   bRet=tfsManager.createDir (userId, "/text1");
	   bRet=tfsManager.mvDir (userId, "/text1", "/text1");
	...
	public void test_17_mvDir_complex()
	{
	   ...
	   tfsManager.createDir (userId, "/text1");
	   tfsManager.createDir (userId, "/text1/text1");
	   tfsManager.createFile (userId, "/text1/text2");
	   tfsManager.createDir (userId, "/text1/text1/text1");
	   tfsManager.createFile (userId, "/text1/text1/text2");

	   tfsManager.createDir (userId, "/text2");
	   tfsManager.createDir (userId, "/text2/text2");
	   tfsManager.createFile (userId, "/text2/text3");

       bRet=tfsManager.mvDir (userId, "/text1/text1", "/text2/text4");
       Assert.assertTrue("mvDir with right path should be true", bRet);
       
       tfsManager.rmFile (userId, "/text1/text2");
       tfsManager.rmDir (userId, "/text1");
       tfsManager.rmFile (userId, "/text2/text4/text2");
       tfsManager.rmDir (userId, "/text2/text4/text1");
       tfsManager.rmDir (userId, "/text2/text4");
       tfsManager.rmDir (userId, "/text2/text2");
       tfsManager.rmFile (userId, "/text2/text3");
       tfsManager.rmDir (userId, "/text2");
   }
	@Test
	public void test_18_mvDir_with_dif_uid()
   {
	...
	public void test_19_mvDir_circle()
	{
	   ...
	   bRet=tfsManager.createDir (userId, "/text1");
	   bRet=tfsManager.createDir (userId, "/text1/text2");
	   bRet=tfsManager.createDir (userId, "/text1/text2/text3");
	   bRet=tfsManager.mvDir (userId, "/text1", "/text1/text2/text3/text4");
