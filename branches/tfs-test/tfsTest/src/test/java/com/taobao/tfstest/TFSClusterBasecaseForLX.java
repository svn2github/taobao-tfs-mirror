...
import org.springframework.context.support.ClassPathXmlApplicationContext;
	...
	public class TFSClusterBasecaseForLX {

		ApplicationContext beanFactory;
		AppGrid tfsGrid;
		ApplicationContext clientFactory;
		
		AppServer tfsSeedClient;
		AppServer tfsReadClient;
		AppServer tfsUnlinkClient;
		...
		/* VIP server */
		public AppServer MASTERSER;
		public AppServer SLAVESER;

		
		public HelpConf conf;
		public HelpHA HA;
		public HelpLog Log;
		public HelpProc Proc;
		public HelpFile File;
		
		
		//Define
		public boolean DEFINE_NS13 = false;
		public int NSINDEX = 0;
		public int DSINDEX = 1;
		public int FAILCOUNTNOR = 0;
		public int FAILCOUNTERR = 1;
		public int BLOCKCOPYCNT = 2;
		public int BLOCKCOPYCNT13 = 3;
		public int DS_CLUSTER_NUM;
		public String NSVIP;
		public String MASTERIP;
		public String SLAVEIP;
		public int NSPORT;
		public String NSCONF;
		public String CLIENTIP;
		public String CLIENTCONF;
		
		/* Path */
		public String TFS_HOME; 
		public String TEST_HOME; 
		public String TFS_LOG_HOME;
		public String TFS_BIN_HOME;
		public String NS_LOG_NAME;
		public String DP_LOG_NAME;
		public String BL_LOG_NAME;
		public String CURR_LOG_NAME;	
		...
		public TFSClusterBasecaseForLX(String strClusterCnfXml)
		{
			beanFactory = new ClassPathXmlApplicationContext(strClusterCnfXml);
			tfsGrid 		= (AppGrid) beanFactory.getBean("tfsGrid");
			clientFactory = new ClassPathXmlApplicationContext(strClusterCnfXml);
			
			tfsSeedClient = (AppServer) clientFactory.getBean("seedClient");
			tfsReadClient = (AppServer) clientFactory.getBean("readClient");
			tfsUnlinkClient = (AppServer) clientFactory.getBean("unlinkClient");
			//final AppServer tfsReadClient_slave = (AppServer) clientFactory.getBean("slaveReadClient");
			//final AppGrid slaveTfsGrid 	= (AppGrid) beanFactory.getBean("slaveTfsGrid");
			/* VIP server */
			MASTERSER = tfsGrid.getCluster(NSINDEX).getServer(0);
			SLAVESER = tfsGrid.getCluster(NSINDEX).getServer(1);
			...
			BLOCKCOPYCNT = 2;
			BLOCKCOPYCNT13 = 3;
			DS_CLUSTER_NUM = tfsGrid.getClusterList().size() - 1;
			NSVIP = tfsGrid.getCluster(NSINDEX).getServer(0).getVip();
			MASTERIP = tfsGrid.getCluster(NSINDEX).getServer(0).getIp();
			SLAVEIP = tfsGrid.getCluster(NSINDEX).getServer(1).getIp();
			NSPORT = tfsGrid.getCluster(NSINDEX).getServer(0).getPort();
			NSCONF = tfsGrid.getCluster(NSINDEX).getServer(0).getConfname();	
			CLIENTIP = tfsSeedClient.getIp();
			CLIENTCONF = tfsSeedClient.getConfname();
			
			/* Path */
			TFS_HOME        = tfsGrid.getCluster(NSINDEX).getServer(0).getDir(); 
			TEST_HOME       = tfsSeedClient.getDir(); 
			TFS_LOG_HOME    = TFS_HOME + "/logs";
			TFS_BIN_HOME    = tfsGrid.getCluster(NSINDEX).getServer(0).getBinPath();
			NS_LOG_NAME     = TFS_LOG_HOME + "/nameserver.log";
			DP_LOG_NAME     = TFS_LOG_HOME + "/dumpplan.log";
			BL_LOG_NAME     = TFS_LOG_HOME + "/blocklist.log";
			CURR_LOG_NAME   = "nameserver.log";	
		}
		...
		public boolean setSeedFlag(int iFlag)
		{
			...
			return bRet;//设置一个 写的标志 返回 true表示成功  反之失败
		}
