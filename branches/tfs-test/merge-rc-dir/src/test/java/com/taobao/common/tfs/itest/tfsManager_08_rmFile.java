...
public class tfsManager_08_rmFile extends tfsNameBaseCase 
{
	...
	{	   
	   ...
	   bRet=tfsManager.rmFile(appId, userId, "/textrmFile");
	...
	{	   
	   boolean bRet;
	   log.info( "test_01_rmFile_right_filePath" );
	   tfsManager.saveFile(appId, userId, resourcesPath+"100K","/textrmFile");
	   bRet=tfsManager.rmFile(appId, userId, "/textrmFile");
	   Assert.assertTrue("Remove File with right path should be true", bRet);
	}
	@Test
	...
	{	   
	   ...
	   tfsManager.saveFile(appId, userId, resourcesPath+"1G","/textrmFile");
	   bRet=tfsManager.rmFile(appId, userId, "/textrmFile");
	   Assert.assertTrue("Remove File with right path should be true", bRet);
	}
	@Test
	...
	{	   
	   boolean bRet;
	   log.info( "test_10_rmFile_large_File" );
	   tfsManager.saveFile(appId, userId, resourcesPath+"3M","/textrmFile");
	   int len = 1024*1024*8;
