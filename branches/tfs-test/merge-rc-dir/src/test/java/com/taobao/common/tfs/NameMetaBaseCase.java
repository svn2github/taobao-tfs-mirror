...
public class NameMetaBaseCase extends TfsBaseCase{
    ...
    protected final static ClassPathXmlApplicationContext serverFactory = new ClassPathXmlApplicationContext("nameMetaServer.xml");
    protected final static AppGrid nameMetaGrid = (AppGrid)serverFactory.getBean("nameMetaGrid");
    protected final static ClassPathXmlApplicationContext clientFactory = new ClassPathXmlApplicationContext("nameMetaClient.xml");
    protected final static AppServer nameMetaClient = (AppServer)clientFactory.getBean("nameMetaClient");
