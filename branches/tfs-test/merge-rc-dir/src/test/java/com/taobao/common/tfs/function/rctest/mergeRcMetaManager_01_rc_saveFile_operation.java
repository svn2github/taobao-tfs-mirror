...
public class mergeRcMetaManager_01_rc_saveFile_operation extends RcBaseCase {
  ...
  public void Function_05_saveFile_1k(){
    ...
    String sRet = null;
    System.out.println("Info: appId=" + appId +",userId=" + userId);
    sRet=tfsManager.saveFile(localFile, null, null, false);
    Assert.assertNotNull(sRet);
//    bRet=tfsManager.saveFile(appId, userId, localFile, "test011_1k.jpg");
//    Assert.assertTrue(bRet);
    sleep(MAX_STAT_TIME);
...
//    log.info("tfsManager.rmFile(appId, userId, /mtest_new):" + bRet);
 
    bRet=tfsManager.saveFile(appId, userId, localFile, "/mtest_new");
    Assert.assertTrue(bRet);
