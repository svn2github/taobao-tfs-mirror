...
/**
 * @author Administrator/lexin.wxx
 */
public class Function_tair_cache_test extends RcBaseCase{
    public String appIp1 = "11.232.3.12";
    public String appIp2 = "11.232.5.21";
	private String resourcesPath="/home/admin/workspace/mazhentong.pt/tfs-test/src/test/resource/";
    ...
    /*
     * 姝ｇ‘鎻掑叆鏈湴鍜岃繙绋媍ache鏈湴杩滅▼鍧囨湭鍛戒腑鏃?鏄惁鑳借鎴愬姛
     */
    ...
    @Test
    public void Function_11_local_cache_invalid_and_remote_cache_invalid() throws Exception {
        ...
        caseName = "Function_11_local_cache_invalid_and_remote_cache_invalid";
        log.info(caseName + "===> start");
        ...
        bRet = tfsManager.fetchFile(sRet, null, output);
        System.out.println("@@@@fetchFile return: "+bRet);
        Assert.assertTrue(bRet);
        Assert.assertEquals(getCrc(localFile), getCrc("tmp"));
	...
	@Test
	public void Function_14_with_large_file_happy_path() throws Exception {
		String segmentFile = "segment_info.jpg";
		OutputStream output = new FileOutputStream(segmentFile);
	    ...
	    bRet = tfsManager.fetchFile("T1GtdTByhT1RCvBVdK", null, output);    
		
	    bRet = tfsManager.fetchFile("T1GtdTByhT1RCvBVdK", null, "10M_part_"+0+ ".jpg"); 	
	}
	...
	/**
	    ...
	    */
	   @Test
	   public void Function_15_with_large_file_remote_cache_part_hit() throws Exception {
	      String segmentFile = "segment_info.jpg";
	      OutputStream output = new FileOutputStream(segmentFile);

	      boolean bRet = false;
	      caseName = "Function_15_with_large_file_happy_path";
	      log.info(caseName + "===> start");
