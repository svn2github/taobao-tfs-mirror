...
public class RcTfsManager_13_unlinkFile extends tfsNameBaseCase 
{
    ...
    public  void  test_01_saveFile_then_unlinkFile()
	{
		...
		info=tfsManager.statFile("T1voVTB4YT1RCvBVdK", null);
		Assert.assertNotNull(info);
		System.out.println("The tfs file name is "+ info.getId());
		
		Bret=tfsManager.unlinkFile("T1f5WTBydT1RCvBVdK", null);
		...
		Bret=tfsManager.unlinkFile("T1aoWTBy_T1RCvBVdK", null);
		Assert.assertTrue(Bret);
		...
		Bret=tfsManager.unlinkFile("T1voVTB4YT1RCvBVdK", null);
		Assert.assertTrue(Bret);
...
//		System.out.println(info.getFlag());
    ...
    public  void  test_02_saveFile_simpleName_then_unlinkFile()
	{
		...
		Assert.assertEquals(info.getFlag(),1);
	}
