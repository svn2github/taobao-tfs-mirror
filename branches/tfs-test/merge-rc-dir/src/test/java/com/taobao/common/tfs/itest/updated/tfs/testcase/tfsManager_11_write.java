...
//    public void test() 
//	{
//	   boolean ret = tfsManager.createFile(appId, userId, "/text1"); 
//	   Assert.assertTrue(ret);
//       String s = "test for test";
//       long length = s.length();
//       byte[] data = s.getBytes();
//       Assert.assertNotNull(data);
//       long lret = tfsManager.write(appId, userId, "/text1", 0, data, 0, length);
...
//    }
    ...
    public void test_18_write_large() throws IOException 
	{
	   ...
	   tfsManager.createFile(appId, userId, "/text"); 
	   int localCrc = getCrc(resourcesPath+"10M"); 
	   byte data[]=null;
	   data=getByte(resourcesPath+"10M");
	   long len = 10*(1<<20);
	   long offset=0;
	   long dataOffset=0;
	   long  Ret;
	   ...
	   tfsManager.fetchFile(appId, userId, resourcesPath+"temp", "/text");
	   int TfsCrc = getCrc(resourcesPath+"10M");
	   Assert.assertEquals(TfsCrc,localCrc);
	   tfsManager.rmFile(appId, userId, "/text");
    }
	@Test
