...
public class defaultTfsBaseCase extends BaseCase
{
//	/*____________________________一些server的配置config&server___________________________________*/
//	protected boolean grid_started = false;
...
//	
//	/*_______________________原生Tfs需要的一些配置_______________________________________*/
...
//	/*__________________________________一些预定的，不知道有什么用_________________________________________________*/
//	
//	
...
//	
//	/*____________________________配置文件的读取____________________________________________________________*/
//	/* Path */
...
//	
//	/*__________________________高端配置区__________________________________________*/
//	
//	
//	/* Column numbers */
...
//	
//	/* Client conf */
//	final public String NS_IP = "ns_ip";
...
//	
//	/*_____________________使用gaia替换掉______________________________________*/
...
//	
//	/* VIP server */
//	/*_____________________通过config和server来进行修改__________________*/
...
//	
//	
//	/*___________________________第一函数区________________________________*/
//	
//	/*______________睡觉函数，后通过时间函数实现________________________*/
...
//	}
//	
//	/*_______________________需要通过Gaia来实现的的一些代码_______________________________________________*/
//	
//	
//	//write
...
//
//	
//	/*_______________________________第二函数区_______________________________________________*/	
...
//	
//	/*_____________________________一些小设置_________________________________________________*/
...
//	{
//		boolean bRet = false;
//		bRet = conf.confReplaceSingleByPart(CLIENTIP, CLIENTCONF, "public", NS_IP, nsAddr);
//		return bRet;
//	}
//
...
//	
//	
//	/*___________________________第三函数区____________________________________*/	
//	/*___________________________各种server配置文件设置，需要换方法_______________________________________*/
...
//			return fRet;
//		}
//		iFailCount = (int) (context.get(context.size() - 1) - context.get(context.size() - 2));
...
//	} 
//	
///*_____________________这个地域的函数需要挪动位置，这里是是mv为分类的不好______________________________________________*/	
...
//	
//	
//	/*__________________________第四函数区，机器操作____________________________________________________*/
...
//	
//	
//	/*______________________________第五函数区 check区___________________________________*/
...
//		if (DEFINE_NS13) 
//		{
//			cmd = "cd " + TFS_BIN_HOME + "; ./showssm -f ../conf/ns.conf -t 1 | grep -v \\\"TOTAL\\\" | grep \\\"" + iBlockCnt + "$\\\" | wc -l";
//		}
//		else 
//		{
//			cmd = "cd " + TFS_BIN_HOME + "; ./ssm -s " + NSVIP + ":" + port + " -i " + "\\\"block\\\" | grep -v \\\"TOTAL\\\" | grep \\\"" + iBlockCnt + "$\\\" | wc -l";
//		}
//		
...
//			else 
//			{
//				cmd = "cd " + TFS_BIN_HOME + "; ./ssm -s " + MASTERSER.getIp() + ":" + MASTERSER.getPort() + " -i " + "\\\"block\\\" | grep -v \\\"TOTAL\\\" | grep \\\"" + iBlockCnt + "$\\\" | wc -l";
//			}
//			bRet = Proc.cmdOutBase(MASTERSER.getIp(), cmd, null, 1, null, listOut);
//			if (bRet == false) return bRet;
//			
...
//		else 
//		{
//			cmd = "cd " + TFS_BIN_HOME + "; ./ssm -s " + SLAVESER.getIp() + ":" + SLAVESER.getPort() + " -i " + "\\\"block\\\" | grep -v \\\"TOTAL\\\" | grep \\\"" + iBlockCnt + "$\\\" | wc -l";
//		}
//		
...
//
//	
///*____________________说是没用了____________________________________________*/
...
////			if (iLoop == 0)
////			{
////				strCmd = "cd " + TFS_LOG_HOME + "; grep \\\"" + PLANSEQNO + "\\\" " + ProcessLog + " | sed \\\"s/].*plan seqno/]plan seqno/\\\" >" + DP_LOG_NAME;
////			}
////			else
////			{
////				strCmd = "cd " + TFS_LOG_HOME + "; grep \\\"" + PLANSEQNO + "\\\" " + ProcessLog + " | sed \\\"s/].*plan seqno/]plan seqno/\\\" >>" + DP_LOG_NAME;
...
//		cmd = "grep \\\"send replicate command succ\\\" /home/admin/tfs14/logs/nameserver.log \"|" +"awk '{print $11}'|awk -F \",\" '{print $1}'|sort|uniq -c|grep -v \"1 \"\"";
//		int checkCount = 0;
//		while (checkCount < 5)
//		{
//			bRet = Proc.proStartBase(MASTERIP, cmd, results);
//			if (bRet == false) return bRet;
//			log.debug("chkMultiReplicateBlock result size: " + results.size());
//			for (int i = 0; i < results.size(); i++) 
//			{
//				log.debug("chkMultiReplicateBlock results " + results.get(i));
//			}
//			if (results.size() > 0)
//				return false;
//			checkCount++;
...
//		return bRet;
//	}
//	/*__________________第六函数区，全是get的______________________________*/
...
//		String strCmd = "grep -m "+ planNum + " \\\"" + PLANSEQNO + "\\\" " + NS_LOG_NAME + " | grep " + "\\\"" + STATUS_BEGIN + "\\\"" + " | sed \\\"s/].*plan seqno/]plan seqno/\\\" | awk '{print $" +PRIORITY_DP_COL + "}'";
//
//		int checkCount = 0;
...
//		return bRet;
//	}
///*_________________________。。。。。不知道怎么说了________________________________________________*/
...
//	} 
//
//	/*___________________________Set 区__________________________________________*/
...
//	}
//	
//	/*___后面以对象分类__________________________________*/
...
//			log.debug("ds: " + dsIp + " blk num before: " + blockDisBefore.get(dsIp) + ", after: " + entry.getValue());
//		}
//		
...
//		else 
//		{
//			strCmd = TFS_BIN_HOME + "/ssm -s " + NSVIP + ":" + NSPORT + " -i server";
//		}
//		ArrayList<String> result = new ArrayList<String>();
//		String strPreValue;
//		String strValue = "";
...
//		bRet = Proc.proStartBase(tfsAppGrid.getCluster(DSINDEX).getServer(0).getIp(),startCmd);
//		
...
//	
//	
//	/*___________________________比较多啊___________________________________*/
...
//		else
//		{
//			cmd = "cd " + TFS_BIN_HOME + "; ./ssm -s " + ip + ":" + iPort + " -i " + "\\\"block\\\" | grep -v \\\"TOTAL\\\" | grep \\\"" + iBlockCnt + "$\\\" | wc -l";
//		}		
...
//		ArrayList<String> listOut = new ArrayList<String>();
//		
//		String cmd = "cd " + TFS_BIN_HOME + "; ./showssm -f ../conf/" + confName + " -t 1 | grep \\\"" + iBlockCnt + "$\\\" | grep -v \\\"TOTAL\\\" | wc -l";
//		bRet = Proc.cmdOutBase(MASTERSER.getIp(), cmd, null, 1, null, listOut);
//		if (bRet == false) return -1;
//		
//		try
...
//		else 
//		{
//			cmd = "cd " + TFS_BIN_HOME + "; ./ssm -s " + ip + ":" + iPort + " -i " + "\\\"server\\\"  |grep -v \\\"TOTAL\\\" |grep \\\"G\\\" |wc -l";
//		}		
//		bRet = Proc.cmdOutBase(MASTERSER.getIp(), cmd, null, 1, null, listOut);
//		if (bRet == false) return -1;
//		
