...
TEST_F(TfsInit,test_01_mvFile_right)
{
   ...
   ret=tfsclient->create_file(appId,uid,"/test1");
   EXPECT_EQ(0,ret);
   
   ret=tfsclient->mv_file(appId,uid,"/test1","/test2");
   EXPECT_EQ(0,ret);
   
   ret=tfsclient->rm_file(appId,uid,"/test2");
   EXPECT_EQ(0,ret);
   ret=tfsclient->rm_file(appId,uid,"/test1");
   EXPECT_GT(0,ret);
}
...
TEST_F(TfsInit,test_02_mvFile_null_destFilePath)
{
   ...
   ret=tfsclient->mv_file(appId,uid,"/test1",NULL);
   EXPECT_GT(ret,0);
...
TEST_F(TfsInit,test_03_mvFile_empty_destFilePath)
{
   ...
   char name[1]="";
   ret=tfsclient->mv_file(appId,uid,"/test1",name);
   EXPECT_GT(ret,0);
...
TEST_F(TfsInit,test_04_mvFile_wrong_destFilePath_1)
{
   ...
   ret=tfsclient->mv_file(appId,uid,"/test1","/");
   EXPECT_GT(ret,0);
...
TEST_F(TfsInit,test_07_mvFile_leap_Filename)
{
   ...
   ret=tfsclient->mv_file(appId,uid,"/test1","/test2/test");
   EXPECT_GT(0,ret);
...
TEST_F(TfsInit,test_09_mvFile_null_srcFilePath)
{
   ...
   ret=tfsclient->mv_file(appId,uid,NULL,"/test2");
   EXPECT_GT(ret,0);   
}
...
TEST_F(TfsInit,test_10_mvFile_empty_srcFilePath)
{
   ...
   char name[1]="";
   ret=tfsclient->mv_file(appId,uid,name,"/test2");
   EXPECT_GT(ret,0);   
}
...
TEST_F(TfsInit,test_11_mvFile_wrong_srcFilePath_1)
{
   ...
   ret=tfsclient->mv_file(appId,uid,"/","/test2");
   EXPECT_GT(ret,0);   
}
...
TEST_F(TfsInit,test_13_mvFile_with_same_name)
{
   ...
   ret=tfsclient->mv_file(appId,uid,"/test1","/test1");
   EXPECT_GT(ret,0);
