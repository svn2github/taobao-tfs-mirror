...
TEST_F(TFS_Init,01_get_bucket_tag)
{
  int Ret ;
...
TEST_F(TFS_Init,02_get_bucket_tag_bucket_name_is_null)
{
  int Ret ;
...
TEST_F(TFS_Init,03_get_bucket_tag_bucket_is_empty)
{
  int Ret ;
...
TEST_F(TFS_Init,04_get_bucket_tag_double)
{  
  int Ret ;
  const char* bucket_name = "a1a";
  tfs::common::UserInfo user_info;
...
TEST_F(TFS_Init,05_get_bucket_tag_is_null)
{
  int Ret ;
  const char* bucket_name = "a1a";
  tfs::common::UserInfo user_info;
...
TEST_F(TFS_Init,06_get_bucket_tag_is_empty)
{
  int Ret ;
  const char* bucket_name = "a1a";
  tfs::common::UserInfo user_info;
...
TEST_F(TFS_Init,07_get_bucket_tag_has_one_tag)
{
  int Ret ;
  const char* bucket_name = "a1a";
  tfs::common::UserInfo user_info;
...
TEST_F(TFS_Init,08_get_bucket_tag_has_no_tag)
{
  int Ret ;
  const char* bucket_name = "a1a";
  tfs::common::UserInfo user_info;
...
TEST_F(TFS_Init,09_get_bucket_tagi_has_two_tag)
{
  int Ret ;
  const char* bucket_name = "a1a";
  tfs::common::UserInfo user_info;
