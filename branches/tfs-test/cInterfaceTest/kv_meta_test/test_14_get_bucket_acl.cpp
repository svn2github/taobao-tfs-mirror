...
TEST_F(TFS_Init,01_get_bucket_acl_read_write_acp)
{
  int Ret ;
  ...
  bucket_acl_map.insert(std::make_pair(1,READ|WRITE_ACP|READ_ACP));
...
TEST_F(TFS_Init,01_get_bucket_acl_write)
{
  int Ret ;
  const char* bucket_name = "ala";
  tfs::common::UserInfo user_info;
...
TEST_F(TFS_Init,01_get_bucket_acl_read_write_read_acp)
{
  int Ret ;
...
TEST_F(TFS_Init,02_get_bucket_null)
{
  int Ret ;
...
TEST_F(TFS_Init,03_get_bucket_empty)
{
  int Ret ;
...
TEST_F(TFS_Init,04_get_bucket_double)
{
  int Ret ;
...
TEST_F(TFS_Init,05_get_bucket_acl_userinfo_is_null)
{
  int Ret ;
  const char* bucket_name = "a1a";
  tfs::common::UserInfo user_info;
