...
TEST_F(TFS_Init,01_get_bucket_logging)
{
  ...
  Ret = kv_meta_client.get_bucket_logging(bucket_name, &logging_status, &target_bucket_name_get, &target_prefix_get, user_info);
  EXPECT_EQ(Ret,0);
