...
//TEST_F(TfsInit,03_write_right_more_count)//maybe wrong
//{
//   char tfs_name[19];
//   int32_t tfs_name_len=19;
//   int64_t Ret;
...
TEST_F(TfsInit,08_write_large_NULL_key)
{
   char tfs_name[19];
   int32_t tfs_name_len=19;
   int64_t Ret;
...
TEST_F(TfsInit,09_write_large_wrong_key)
{
   char tfs_name[19];
   int32_t tfs_name_len=19;
   int64_t Ret;
   ...
   const char* suffix=NULL;
   const bool large = true;
   const char* local_key = "shdfjksahdfklsjah";
...
TEST_F(TfsInit,10_write_wrong_count)
{
   char tfs_name[19];
   int32_t tfs_name_len=19;
   int64_t Ret;
...
TEST_F(TfsInit,11_write_wrong_fd_1)
{
   int64_t Ret;
...
TEST_F(TfsInit,12_write_wrong_fd_2)
{
   int64_t Ret;
...
TEST_F(TfsInit,13_write_wrong_fd_3)
{
   int64_t Ret;
