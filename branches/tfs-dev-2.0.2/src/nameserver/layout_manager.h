...
namespace tfs
{
  namespace nameserver
  {
    ...
    class LayoutManager
    {
      ...
      int update_relation(ServerCollect* server, const std::set<common::BlockInfo>& blocks, EXPIRE_BLOCK_LIST& expires, const time_t now);
      ...
      void check_all_server_report_block();
