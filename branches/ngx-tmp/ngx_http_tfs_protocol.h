...
typedef enum
{
    ...
    NGX_HTTP_TFS_REQ_KVMETA_GET_OBJECT_MESSAGE = 300,
    NGX_HTTP_TFS_RSP_KVMETA_GET_OBJECT_MESSAGE = 301,
    NGX_HTTP_TFS_REQ_KVMETA_PUT_OBJECT_MESSAGE = 302,
    NGX_HTTP_TFS_REQ_KVMETA_DEL_OBJECT_MESSAGE = 303,
    NGX_HTTP_TFS_RSP_KVMETA_DEL_OBJECT_MESSAGE = 304,
    NGX_HTTP_TFS_REQ_KVMETA_HEAD_OBJECT_MESSAGE = 305,
    NGX_HTTP_TFS_RSP_KVMETA_HEAD_OBJECT_MESSAGE = 306,
    NGX_HTTP_TFS_REQ_KVMETA_PUT_BUCKET_MESSAGE = 307,
    NGX_HTTP_TFS_REQ_KVMETA_GET_BUCKET_MESSAGE = 308,
    NGX_HTTP_TFS_RSP_KVMETA_GET_BUCKET_MESSAGE = 309,
    NGX_HTTP_TFS_REQ_KVMETA_DEL_BUCKET_MESSAGE = 310,
    NGX_HTTP_TFS_REQ_KVMETA_HEAD_BUCKET_MESSAGE = 311,
    NGX_HTTP_TFS_RSP_KVMETA_HEAD_BUCKET_MESSAGE = 312,
    NGX_HTTP_TFS_REQ_KV_RT_GET_TABLE_MESSAGE = 352,
    NGX_HTTP_TFS_RSP_KV_RT_GET_TABLE_MESSAGE = 353,
    NGX_HTTP_TFS_REQ_KV_GET_AUTHORIZE_MESSAGE = 372,
    NGX_HTTP_TFS_RSP_KV_GET_AUTHORIZE_MESSAGE = 373,
...
typedef struct {
    ngx_http_tfs_header_t                   header;
    uint8_t                                 reserse;
} NGX_PACKED ngx_http_tfs_kv_rs_request_t;
...
typedef struct {
    ngx_http_tfs_header_t                     header;
    uint32_t                                  access_key_id_len;
    u_char                                    access_key_id[];
} NGX_PACKED ngx_http_tfs_kv_ms_get_authorize_request_t;
...
} NGX_PACKED ngx_http_tfs_kv_ms_put_bucket_request_t;
...
typedef struct {
 ...
 /* uint32_t                                  prefix_len;
    ...
    uint8_t                                   delimiter;
    ngx_http_tfs_user_info_t                  user_info;*/
} NGX_PACKED ngx_http_tfs_kv_ms_get_bucket_request_t;
...
typedef struct {
    ...
    u_char                                    bucket_name[];
 /* ngx_http_tfs_user_info_t                  user_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_del_bucket_request_t;
...
typedef struct {
    ...
    u_char                                    bucket_name[];
 /* ngx_http_tfs_user_info_t                  user_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_head_bucket_request_t;
...
typedef struct {
    ...
    u_char                                    bucket_name[];
 /* ngx_http_tfs_bucket_meta_info_t           bucket_meta_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_head_bucket_response_t;
...
typedef struct {
 ...
 /* uint32_t                                  object_name_len;
    ...
    ngx_http_tfs_user_info_t                  user_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_put_object_request_t;
...
typedef struct {
 ...
 /* uint32_t                                  object_name_len;
    ...
    uint64_t                                  length;
    ngx_http_tfs_user_info_t                  user_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_get_object_request_t;
...
typedef struct {
    ...
    uint8_t                                   still_have;
 /* ngx_http_tfs_object_info_t                object_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_get_object_response_t;
...
typedef struct {
 ...
 /* uint32_t                                  object_name_len;
    u_char                                    object_name[];
    ngx_http_tfs_user_info_t                  user_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_del_object_request_t;
...
typedef struct {
    ...
    uint8_t                                   still_have;
 /* ngx_http_tfs_object_info_t                object_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_del_object_response_t;
...
typedef struct {
 ...
 /* uint32_t                                  object_name_len;
    u_char                                    object_name[];
    ngx_http_tfs_user_info_t                  user_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_head_object_request_t;
...
typedef struct {
 ...
 /* uint32_t                                  object_name_len;
    u_char                                    object_name[];
    ngx_http_tfs_object_info_t                object_info; */
} NGX_PACKED ngx_http_tfs_kv_ms_head_object_response_t;
