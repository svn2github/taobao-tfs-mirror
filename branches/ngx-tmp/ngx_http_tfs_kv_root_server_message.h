...
#ifndef _NGX_HTTP_TFS_KV_ROOT_SERVER_MESSAGE_H_INCLUDED_
#define _NGX_HTTP_TFS_KV_ROOT_SERVER_MESSAGE_H_INCLUDED_
...
#endif  /* _NGX_HTTP_TFS_KV_ROOT_SERVER_MESSAGE_H_INCLUDED_ */
