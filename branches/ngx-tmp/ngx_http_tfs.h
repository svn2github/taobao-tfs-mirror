...
struct ngx_http_tfs_segment_data_s {
    ...
    uint32_t                               curr_crc;    /* current writing data's crc */
    union {
...
typedef struct {
    ...
    ngx_http_tfs_kv_meta_table_t     meta_server_table;
...
struct ngx_http_tfs_s {
    ...
    /* get bucket */
    ngx_http_tfs_get_bucket_ctx_t     get_bucket_ctx;

    /* get object */
    uint32_t                          max_frag_count;
...
ngx_int_t ngx_http_tfs_set_custom_initial_parameters(ngx_http_tfs_t *t);
