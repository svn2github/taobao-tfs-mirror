...
ngx_http_tfs_json_custom_file_info(ngx_http_tfs_json_gen_t *tj_gen,
    ngx_http_tfs_custom_file_info_chain_t *chain, uint8_t file_type)
{
    size_t                            size;
