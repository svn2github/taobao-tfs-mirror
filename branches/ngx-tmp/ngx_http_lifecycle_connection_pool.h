...
typedef struct ngx_http_lifecycle_connection_pool_s ngx_http_lifecycle_connection_pool_t;
...
typedef struct {
    ...
    ngx_queue_t             *free;
} ngx_http_lifecycle_connection_pool_elt_t;


struct ngx_http_lifecycle_connection_pool_s {
    ngx_queue_t             *cache;
    ngx_queue_t             *free;
...
ngx_http_lifecycle_connection_pool_t *ngx_http_lifecycle_connection_pool_init(ngx_pool_t *pool,
    ngx_uint_t max_count, ngx_uint_t bucket_count);

#if (NGX_DEBUG)
void ngx_http_lifecycle_connection_pool_check(ngx_http_lifecycle_connection_pool_t *coon_pool,
    ngx_log_t *log);
#endif
