...
#ifndef TFS_NAMEMETASERVER_METASTORE_HANDLER_H_
#define TFS_NAMEMETASERVER_METASTORE_HANDLER_H_
...
namespace tfs
{
  ...
  {
    class MetaStoreHandler 
    {
      public:
        MetaStoreHandler();
        virtual ~MetaStoreHandler();
      ...
      private:
        DISALLOW_COPY_AND_ASSIGN(MetaStoreHandler);
    };
  }
}
#endif
