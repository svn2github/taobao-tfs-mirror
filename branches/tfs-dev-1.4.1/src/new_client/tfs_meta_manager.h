...
namespace tfs
{
  namespace client
  {
    ...
    {
    public:
      int initialize(const char* ns_ip);
      int64_t read_data(const uint32_t block_id, const uint64_t file_id, 
          void* buffer, const int32_t pos, const int64_t length);

      int64_t write_data(void* buffer, const int64_t pos, const int64_t length, 
