...
namespace tfs
{
  ...
  #pragma pack()
    ...
    enum MessageType
    {
      ...
      OPEN_FILE_MESSAGE = 202,
      OPEN_FILE_RESP_MESSAGE = 203,
      BATCH_OPEN_FILE_MESSAGE = 204,
      BATCH_OPEN_FILE_RESP_MESSAGE = 205,
      WRITE_FILE_MESSAGE = 206,
      WRITE_FILE_RESP_MESSAGE = 208,
      SLAVE_DS_RESP_MESSAGE = 209,
      COMMIT_FILE_MESSAGE = 210,
      COMMIT_BLOCK_UPDATE_MESSAGE = 211,
      STAT_FILE_MESSAGE = 212,
      STAT_FILE_RESP_MESSAGE = 213,
      READ_FILE_MESSAGE = 214,
      READ_FILE_RESP_MESSAGE = 215,
      READ_FILE_V2_MESSAGE = 216,
      READ_FILE_V2_RESP_MESSAGE = 217,
      DELETE_FILE_MESSAGE = 218,
      CREATE_BLOCK_MESSAGE = 219,
      DELETE_BLOCK_MESSAGE = 220,
      LOCAL_PACKET = 500
    };
