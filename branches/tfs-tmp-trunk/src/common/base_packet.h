...
namespace tfs
{
  ...
  #pragma pack()
    ...
    enum MessageType
    {
      ...
      COMMIT_BLOCK_UPDATE_MESSAGE = 210,
      STAT_FILE_MESSAGE_V2 = 211,
      STAT_FILE_RESP_MESSAGE_V2 = 212,
      READ_FILE_MESSAGE_V2 = 213,
      READ_FILE_RESP_MESSAGE_V2 = 214,
      UNLINK_FILE_MESSAGE_V2 = 215,
      NEW_BLOCK_MESSAGE_V2 = 216,
      REMOVE_BLOCK_MESSAGE_V2 = 217,
      LOCAL_PACKET = 500
    };
