  ...
  namespace checkserver
  {
    class BaseServerHelper
    {
      public:
        ...
        virtual int fetch_check_blocks(const uint64_t ds_id, const common::TimeRange& range, common::VUINT64& blocks) = 0;
        virtual int dispatch_check_blocks(const uint64_t ds_id, const int64_t seqno, const common::VUINT64& blocks) = 0;
    };
  }
}
