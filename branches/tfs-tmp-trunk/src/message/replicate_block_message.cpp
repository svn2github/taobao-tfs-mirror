...
namespace tfs
{
  namespace message
  {
    ...
    {
      TBSYS_LOG(INFO, "seqno: %"PRI64_PREFIX"d, command: %d, expire: %d, block: %"PRI64_PREFIX"u, source: %s, target: %s, start_time: %d, is_move: %s",
        ...
        repl_block_.is_move_ == common::REPLICATE_BLOCK_MOVE_FLAG_NO ? "replicate" : "move");
    }
  }
}
