...
if test "$PHP_TFS_CLIENT" != "no"; then
  ...
  PHP_ADD_LIBRARY_WITH_PATH(tfscommon, ../common, TFS_CLIENT_SHARED_LIBADD)
  PHP_ADD_LIBRARY_WITH_PATH(tfsclient, ../new_client/.libs, TFS_CLIENT_SHARED_LIBADD)
