...
namespace tfs
{
  namespace tools
  {
    ...
    int ShowInfo::show_server(int8_t type, int32_t num, int32_t count, int32_t interval)
    {
    ...
    int ShowInfo::show_machine(int8_t flag, int32_t num, int32_t count, int32_t interval)
    {
      last_server_map_.clear();
      load_last_ds();
      int32_t last_server_size = last_server_map_.size();
    ...
    int ShowInfo::show_block(int8_t type, int32_t num, uint32_t block_id, int32_t count, int32_t interval)
    {
      while (count > 0)
      {
        StatStruct stat;
