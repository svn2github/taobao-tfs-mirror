  ...
  namespace tools
  {
    class ShowInfo
    {
      public:
        ...
        void load_last_ds();
        void save_last_ds();
        int show_server(int8_t flag, int32_t num, int32_t count, int32_t interval);
        int show_machine(int8_t flag, int32_t num, int32_t count, int32_t interval);
        int show_block(int8_t flag, int32_t num, uint32_t block_id, int32_t count, int32_t interval);
